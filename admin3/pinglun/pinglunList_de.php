    ...
    <div class="main-wrap">
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i>
                ...
                <span class="crumb-step">&gt;</span><span>评论详细</span>
            </div>
        </div>
                ...
                <form action="pinglunList_sear.php" method="get">
                    <table class="search-tab">
                        <tr>
                            ...
                            <td><input class="btn btn-primary btn2" id="addnew" value="添加评论" type="button"></td>
        ...
        <div class="result-wrap">
            ...
            $_SESSION['c']=$result['content'];
            ?>
            <div class="insert-tab" width="100%" >
                <p style="margin-bottom: 10px;margin-top: 10px;width: 100px;text-indent: 2em;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;"><?php echo $result[content]; ?></p>
                <p>
                    ...
                    ?>
                    <a href="pinglunList_de.php?id=<?php echo $result["id"]?>">回复(<?php echo $num; ?>)</a>&nbsp;&nbsp;&nbsp;
                    <?php echo $result[datetime]; ?>&nbsp;&nbsp;&nbsp;
                    <a href="del_pinglun.php?fileid=<?php echo $result["id"]?>">删除</a>
                </p>
            </div>
        </div>
        <div class="result-wrap">
            ...
            if($totalcount < 1){
                echo "<span style='color: red'>无相关回复</span>";
            }
            if (!isset($page)) {
                $page=1;
            } //如果没有值,则赋值1
            ...
            while($result = mysql_fetch_array($rs)) {
                $commontid="&commontid=".$_GET["id"];
                ?>
                <div class="result-tab">

                    <p style="text-indent: 2em;"><?php echo $result['content']; ?></p>
                    <p>
                        回复作者:<?php echo $result['author']; ?>&nbsp;&nbsp;&nbsp;
                        <?php echo $result['datetime']; ?>&nbsp;&nbsp;&nbsp;
                        <a href="del_huifu.php?id=<?php echo $result['id'].$commontid;?>">删除</a>
                    </p>
        ...
        <div class="list-page">
            ...
            if ($page != 1) { //页数不等于1
                ?>
                <!--显示上一页-->
                <a href="pinglunList_de.php?page=<?php echo ($page - 1).$id;?>">上一页</a>
                <?php
            }
            for ($i=1;$i<=$totalPage;$i++) {  //循环显示出页面
                ?>
                <a href="pinglunList_de.php?page=<?php echo $i.$id;?>"><?php echo $i;?></a>
                <?php
            }
            if ($page<$totalPage) { //如果page小于总页数,显示下一页链接
                ?>
                <!--显示下一页-->
                <a href="pinglunList_de.php?page=<?php echo ($page + 1).$id;?>">下一页</a>
                <?php
            }
            ?>
        </div>
        ...
        <div class="result-wrap">
            ...
            <form name="myform" action="check_huifu.php?commontid=<?php echo $_GET['id'];?>" id="myform" method="post">
                <div class="result-content">
                    <table class="insert-tab" width="100%">
                        <tbody>
                        <tr>
                            <td><textarea name="huifu_text" class="common-textarea" id="content" cols="30" style="width: 98%;border-radius: 5px" rows="10" required></textarea></td>
                        </tr>
                        <tr>
                            <td>
                                <input name="huifu_btn" class="btn btn-primary btn6 mr10" value="确定" type="submit">
