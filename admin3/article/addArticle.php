...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
                <form name="myform" action="check_article.php" id="myform" method="post">
                    <div class="result-content">
                        <table class="insert-tab" width="100%">
                            <tbody>
                            <tr>
                                <th><i class="require-red">*</i>博客主题：</th>
                                <td>
                                    <input class="common-text required" id="txt_title" name="txt_title" size="50" required type="text">
                                </td>
                            </tr>
                            <tr>
                                <th><i class="require-red">*</i>博客内容：</th>
                                <td><textarea name="file" class="common-textarea" id="file" cols="30" style="width: 98%;" required rows="10"></textarea></td>
                            </tr>
                            <tr>
                                <th></th>
                                <td>
                                    <input name="btn_tj" class="btn btn-primary btn6 mr10" value="添加" type="submit">
